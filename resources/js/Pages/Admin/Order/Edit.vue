...
const form = useForm({
    ...
    item_count: "",
    item_total: "",
    order_description: props.order.order_description,
});
...
<template>
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiMenu" title="Edit Order" main>
                <BaseButton
            ...
            <CardBox form @submit.prevent="form.post(handleSubmit)">
                ...
                <div v-for="(i, index) in localItems" :key="index">
                    <div class="flex space-x-5">
                        ...
                        >
                            <FormControl
                                v-model="localItems[index].items"
                                type="select2"
                        ...
                        >
                            <FormControl
                                ...
                                @input="updateItemTotal(localItems[index])"
                            >
                                <div
                                    class="text-red-400 text-sm"
