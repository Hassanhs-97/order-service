...
<template>
    <LayoutAuthenticated>
        <Head title="Orders" />
        <SectionMain>
            <SectionTitleLineWithButton :icon="mdiMenu" title="Orders" main>
                <BaseButton
                    v-if="can.delete"
                    :route-name="route('admin.orders.create')"
                    :icon="mdiPlus"
                    label="Add"
                    color="info"
                    rounded-full
            ...
            <CardBox class="mb-6" has-table>
                <form @submit.prevent="form.get(route('admin.orders.index'))">
                    <div class="py-2 flex">
                        <div class="flex pl-4">
                            <input
                                type="search"
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Total Price</th>
                            <th>Created At</th>
                            <th v-if="can.edit || can.delete || can.manage">
                                Actions
                            </th>
                        </tr>
                    </thead>
